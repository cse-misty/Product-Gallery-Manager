...
<div class="main-content">
    ...
    <div class="section-body">
        ...
        <div class="col-12">
            ...
            <form class="form p-2" action="{{Route('admin.permissions.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="card-body pb-0">
                            <div class="form-group">
                              <label style="margin-left:0px!important;">Permission Name</label>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <button type="submit"  class="btn ms-1 btn-primary">Create</button>
                    </div>
                </div>
            </form>
            </div>
